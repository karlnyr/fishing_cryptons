...
python3 $PY_SCRIPT_PATH $OUT_FILE_PATH/$OUT_NAME'_tid.txt' $3 $4 \
    > $OUT_FILE_PATH/$OUT_NAME'_filtered_tid.txt'

fgrep -w -f $OUT_FILE_PATH/$OUT_NAME'_filtered_tid.txt' $ID_TO_NAME_PATH | \
